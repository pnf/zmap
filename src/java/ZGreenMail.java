 ...
 * @since Jan 28, 2006
 */
public class ZGreenMail {
    Managers managers;
    HashMap services;


    public static MimeMessage newEmptyMimeMessage() {
     ...
     */
    public ZGreenMail() {
        this(ServerSetupTest.ALL, new Managers());
    }
     ...
     * @param config
     */
    public ZGreenMail(ServerSetup config, Managers managers_) {
        this(new ServerSetup[]{config},managers_);
    }
